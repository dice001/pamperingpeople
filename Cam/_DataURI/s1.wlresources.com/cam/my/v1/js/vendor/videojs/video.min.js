...
! function(a) {
    ...
    return function b(a, c, d) {
                ...
                N = function(b) {
                    ...
                    return h(c, b), c.prototype.manualProgressOn = function() {
                        ...
                        if (b) {
                            ...
                            c.on("addtrack", d), c.on("removetrack", e), this.on("ready", this.addWebVttScript_);
                            var f = function() {
                            ...
                            g(), b.addEventListener("change", g), this.on("dispose", function() {
                                ...
                                for (var a = 0; a < b.length; a++) {
                                    var h = b[a];
                                    h.removeEventListener("cuechange", f)
                                }
                            })
                        }
        ...
        93: [function(b, c, d) {
            ...
            n.autoSetupTimeout(1, g), g.VERSION = "5.17.0", g.options = x["default"].prototype.options_, g.getPlayers = function() {
