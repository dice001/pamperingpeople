        ...
        n("moxie/core/utils/Basic", [], function() {
                    ...
                    extList2mimes: function(t, i) {
                        ...
                        for (r = 0; r < t.length; r++)
                            for (n = t[r].extensions.split(/\s*,\s*/), o = 0; o < n.length; o++) {
                                if ("*" === n[o]) return [];
                                if (a = s.mimes[n[o]], a && -1 === e.inArray(a, u) && u.push(a), i && /^\w+$/.test(n[o])) u.push("." + n[o]);
                                else if (!a) return []
                            }
                        return u
                    },
            ...
            var e = function(t, i) {
                    for (var n = ["source", "scheme", "authority", "userInfo", "user", "pass", "host", "port", "relative", "path", "directory", "file", "query", "fragment"], r = n.length, o = {
                            http: 80,
                            https: 443
                        }, a = {}, s = /^(?:([^:\/?#]+):)?(?:\/\/()(?:(?:()(?:([^:@\/]*):?([^:@\/]*))?@)?([^:\/?#]*)(?::(\d*))?))?()(?:(()(?:(?:[^?#\/]*\/)*)()(?:[^?#]*))(?:\\?([^#]*))?(?:#(.*))?)/, u = s.exec(t || ""); r--;) u[r] && (a[n[r]] = u[r]);
                    if (!a.scheme) {
            ...
            function h() {
                ...
                e.extend(this, I, {
                    ...
                    open: function(o, a, s, u, c) {
                        ...
                        if (y = u || l.user, w = c || l.pass, T = s || !0, T === !1 && (i("timeout") || i("withCredentials") || "" !== i("responseType"))) throw new t.DOMException(t.DOMException.INVALID_ACCESS_ERR);
                ...
                a.call(this), e.extend(this, {
                    ...
                    embed: function(n, r) {
                        function o(t, r) {
                            ...
                            if (u.can("use_data_uri_of", d.length)) n.innerHTML = '<img src="' + d + '" width="' + o.width + '" height="' + o.height + '" />', o.destroy(), c.trigger("embedded");
                            else {
                                var h = new s;
                        ...
                        m.upload ? (i.withCredentials && (m.withCredentials = !0), m.addEventListener("load", function(e) {
                            ...
                            switch (m.readyState) {
                                ...
                                case 3:
                                    ...
                                    break;
                                case 4:
                                    m.onreadystatechange = function() {}, 0 === m.status ? s.trigger("error") : s.trigger("load")
                            }
                ...
                function a(i, r) {
                    ...
                    for (o = p.SHORT(i), a = 0; o > a; a++)
                        if (g = [], h = i + 2 + 12 * a, s = r[p.SHORT(h)], s !== t) {
                            if (u = v[p.SHORT(h += 2)], c = p.LONG(h += 2), m = y[u], !m) throw new n.ImageError(n.ImageError.INVALID_META_ERR);
            ...
            function c() {
                ...
                function h(e, t) {
                    ...
                    }, n.readAsDataURL(e), void 0) : t(e.getAsDataURL())
                }
                ...
                function p() {
                    x && (x.purge(), x = null), y = g = v = w = null, b = !1
                }
                var g, x, v, y, w, E = this,
                    b = !1,
                    R = !0;
                t.extend(this, {
                    loadFromBlob: function(e) {
                        ...
                        return w = e, e.isDetached() ? (y = e.getSource(), m.call(this, y), void 0) : (h.call(this, e.getSource(), function(e) {
                            r && (y = l(e)), m.call(t, e)
                        }), void 0)
                    },
                    ...
                    getAsBinaryString: function(e, t) {
                        if (!b) return y || (y = l(E.getAsDataURL(e, t))), y;
                        if ("image/jpeg" !== e) y = l(E.getAsDataURL(e, t));
                        else {
                            var i;
                            t || (t = 90), c();
                            try {
            ...
            function s() {
                ...
                i.extend(this, {
                    init: function(t) {
                        var i, a = this,
                            s = a.getRuntime();
                        u = t, l = t.accept.mimes || o.extList2mimes(t.accept, s.can("filter_by_extension")), i = s.getShimContainer(),
                            function() {
                                var e, o, l;
            ...
            function u() {
                ...
                t.extend(this, {
                    send: function(d, m) {
                        ...
                        } else f = t.guid("uid_"), p = document.createElement("form"), p.setAttribute("id", f + "_form"), p.setAttribute("method", d.method), p.setAttribute("enctype", "multipart/form-data"), p.setAttribute("encoding", "multipart/form-data"), y.getShimContainer().appendChild(p);
        ...
        l.addFileFilter("mime_types", function(e, t, i) {
            ...
            function a() {
                ...
                if (this.state == l.STARTED) {
                    for (t = 0; t < T.length; t++) e || T[t].status != l.QUEUED ? i++ : (e = T[t], this.trigger("BeforeUpload", e) && (e.status = l.UPLOADING, this.trigger("UploadFile", e)));
            ...
            function d() {
                var e, t;
                for (w.reset(), e = 0; e < T.length; e++) t = T[e], t.size !== i ? (w.size += t.origSize, w.loaded += t.loaded * t.origSize / t.size) : w.size = i, t.status == l.DONE ? w.uploaded++ : t.status == l.FAILED ? w.failed++ : w.queued++;
            ...
            function E(e, i) {
                ...
                function s() {
                    ...
                    i.status === l.UPLOADING && e.state !== l.STOPPED && (e.settings.send_file_name && (_.name = i.target_name || i.name), u && c.chunks && a.size > u ? (h = Math.min(u, a.size - p), f = a.slice(p, p + h)) : (h = a.size, f = a), u && c.chunks && (e.settings.send_chunk_number ? (_.chunk = Math.ceil(p / u), _.chunks = Math.ceil(a.size / u)) : (_.offset = p, _.total = a.size)), D = new t.xhr.XMLHttpRequest, D.upload && (D.upload.onprogress = function(t) {
                        ...
                        return D.status >= 400 ? (n(), void 0) : (d = e.settings.max_retries, h < a.size ? (f.destroy(), p += h, i.loaded = Math.min(p, a.size), e.trigger("ChunkUploaded", i, {
                            offset: i.loaded,
                            total: a.size,
                            response: D.responseText,
                            status: D.status,
                    ...
                    })) : (o = l.buildUrl(e.settings.url, l.extend(_, e.settings.multipart_params)), D.open("post", o, !0), l.each(e.settings.headers, function(e, t) {
                        D.setRequestHeader(t, e)
                    }), D.hasRequestHeader("Content-Type") || D.setRequestHeader("Content-Type", "application/octet-stream"), D.send(f, {
                        runtime_order: e.settings.runtimes,
                        required_caps: e.settings.required_features,
                        preferred_caps: F,
                        swf_url: e.settings.flash_swf_url,
            ...
            I = {
                ...
                removeFile: function(e) {
                    for (var t = "string" == typeof e ? e : e.id, i = T.length - 1; i >= 0; i--)
                        if (T[i].id === t) return this.splice(i, 1)[0]
                },
                splice: function(e, t) {
                    var n = T.splice(e === i ? 0 : e, t === i ? T.length : t),
                        r = !1;
